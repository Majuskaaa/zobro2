...
var AnimalDetail = React.createClass({
  ...
  <AnimalText>
    Naše tygřice se jmenuje Satu. Narodila se 27.&nbsp;března 2004 v&nbsp;Dublinu a do Brna dorazila v&nbsp;říjnu 2005. Od té doby se v&nbsp;jejím výběhu vystřídalo už pět tygrů – Dick, Kampar, Dustin, Dua a Dandys. Poslední zmíněný se narodil 18.&nbsp;února 2012, do Brna přijel v&nbsp;březnu 2014 a je zde stále k vidění. Sice už stihl zplodit dvě mláďata v&nbsp;Zoo Jihlava, ale ani on zatím nebyl úspěšný v&nbsp;rozmnožení svého poddruhu v&nbsp;Brně. Že by za to mohlo jméno naší tygřice? Vždyť Satu znamená v&nbsp;indonéštině jeden – a tak i&nbsp;naše Satu nadále zůstává jen jedna.
  </AnimalText>
    </AnimalTemplate>
    );
  }
