  ...
  render() {
    return (
      <AnimalTemplate firstIndex={[0]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator}>
          <AnimalText>
            Ahoj! Jmenuji se Kamčatka a jsem medvědice kamčatská. Jak už mé jméno napovídá, pocházím z&nbsp;poloostrova Kamčatka, který se nachází v&nbsp;Asii (přesněji v&nbsp;Rusku) a je veliký přibližně jako pětinásobek České republiky. Od nás je vzdálený skoro osm tisíc kilometrů.
          </AnimalText>
          <AnimalText>
            Svůj výběh jsem dříve sdílela s&nbsp;medvědem Jelizarem, který už však není mezi námi, nicméně jsme spolu stihli vychovat hned tři mláďata – dvojčata Tobyho a Kubu, kteří se nám narodili 30.&nbsp;ledna 2012 a o&nbsp;tři roky později odcestovali do soukromé zoo na Ukrajinu, a Bruna. Ten se narodil 29.&nbsp;ledna 2016 a momentálně ho můžeš potkat v&nbsp;zoo v&nbsp;Děčíně.
          </AnimalText>
        ...
        <InPageImage indexes={[2]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator} />
          ...
          <AnimalText>
            Většinu svého života trávíme o&nbsp;samotě. V&nbsp;přírodě společnost vyhledáváme pouze v&nbsp;době, kdy hledáme partnera, se kterým můžeme na svět přivést mláďata. V&nbsp;zoo pak společnost uvítáme hlavně tehdy, když se k&nbsp;nám blíží chovatel a nese něco dobrého na zub.
          </AnimalText>
      </AnimalTemplate>
    );
  }
