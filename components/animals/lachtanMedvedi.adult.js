  ...
  render() {
    return (
      <AnimalTemplate firstIndex={[1]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator}>
          <AnimalText>
             Seznamte se, zde bydlí <Text style={styles.italic}>Callorhinus ursinus</Text>, ploutvonožec z&nbsp;čeledi lachtanovitých. Momentálně zde žije jeden, konkrétně samec Sema. Zdá se vám to jméno zvláštní? Právem, lachtan ho dostal v&nbsp;Rusku, odkud jsme si jej přivezli. Z&nbsp;Rostova na Donu k&nbsp;nám dorazil v&nbsp;noci z&nbsp;19.&nbsp;na 20.&nbsp;prosince 2013.
          </AnimalText>
          <AnimalText>
