    ...
    return (
      <AnimalTemplate firstIndex={[2]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator}>
        ...
        <InPageImage indexes={[1]} thumbnails={THUMBNAILS} images={IMAGES} navigator={this.props.navigator} />
          <AnimalText>
            Zoo Brno chová v&nbsp;současnosti pouze samici Kamčatku, která přivedla se samcem Jelizarem na svět tři mláďata. Samečci Kuba a Toby se narodili 30.&nbsp;ledna&nbsp;2012 a v&nbsp;prosinci roku&nbsp;2014 odcestovali do soukromé ukrajinské zoo. Třetí kluk, sameček Bruno, se narodil 29.&nbsp;ledna&nbsp;2016 a momentálně se nachází v&nbsp;již zmíněné zoo v&nbsp;Děčíně.
          </AnimalText>
      </AnimalTemplate>
    );
  }
